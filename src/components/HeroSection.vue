    ...
    <div class="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center">
      <div class="lg:col-span-3">
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl lg:text-6xl dark:text-white">
          Connecting we Grow<br>
          2021-2026
        </h1>
        <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Prin Erasmus+, oferim <a
            href="http://scoalaprofesionalasfnicolae.ro/" class="text-indigo-600 underline hover:text-indigo-500">școlii
            noastre</a> o educație de top la standarde europene. Împreună inovăm, ne dezvoltăm și atingem
          excelența.</p>
